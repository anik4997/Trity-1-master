# coding: utf-8
#!/usr/bin/env python
import sys, platform, subprocess, socket, time, os, urllib.request, urllib.parse, urllib.error,  random, string, smtplib, urllib.request, urllib.error, urllib.parse, getpass, zipfile
